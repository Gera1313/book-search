...
const SavedBooks = () => {
  const { loading, data } = useQuery(GET_ME); // Added: Used the useQuery Hook to get user data

  const [removeBook] = useMutation(REMOVE_BOOK); // Added: Uses the useMutation Hook for removeBook

  const userData = data?.me || {}; // Added: Gets user data from the query response

  // Creates a function to handle deleting a book
